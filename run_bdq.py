...
from thai.agent.bdq import Bdq

# Path config
path_params_agent = 'config/algorithm/bdq.yaml'
...
agent = Bdq(env.n_components, env.n_c_actions, env.n_c_states, device, **params_agent)
